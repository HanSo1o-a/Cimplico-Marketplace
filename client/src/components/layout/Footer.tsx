        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="/marketplace?vendors=true" className="hover:text-white transition-colors">{t("nav.vendors")}</a></li>
              <li><a href="/marketplace?newArrivals=true" className="hover:text-white transition-colors">{t("nav.newArrivals")}</a></li>
              <li><a href="/marketplace?freeOnly=true" className="hover:text-white transition-colors">{t("nav.freeResources")}</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="hover:text-white transition-colors">{t("footer.refundPolicy")}</a></li>
              <li><a href="#" className="hover:text-white transition-colors">{t("footer.termsOfService")}</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="/auth?vendor=true" className="hover:text-white transition-colors">{t("footer.becomeVendor")}</a></li>
              <li><a href="#" className="hover:text-white transition-colors">{t("footer.vendorGuidelines")}</a></li>
              <li><a href="#" className="hover:text-white transition-colors">{t("footer.uploadRules")}</a></li>
              <li><a href="#" className="hover:text-white transition-colors">{t("footer.sellingTerms")}</a></li>
              <li><a href="#" className="hover:text-white transition-colors">{t("footer.vendorResources")}</a></li>
              <li><a href="/auth" className="hover:text-white transition-colors">{t("footer.vendorLogin")}</a></li>
            </ul>
          </div>
        </div>
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <form className="flex flex-col sm:flex-row gap-2 max-w-lg mx-auto">
              <Input 
                ...
                className="flex-grow py-3 px-4 bg-neutral-700 border-neutral-600 text-white"
              />
